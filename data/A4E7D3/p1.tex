...
In the limit of the parition becoming infinitely finer, the right hand side
approaches the integral
$$
\int_a^b f'(x)\,dx
$$
by the continuity of $f'$. A slight complication comes in when $I$ includes an 
endpoint and $f'$ fails to exist there.
