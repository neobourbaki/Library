...
The *field* $\mathbb{R}$ *of real numbers* is the set of all real numbers, together with the operations of addition and multiplication, as well as an order relation, defined as follows:
