A *smooth* $n$-*manifold* is a set $M$, together with a collection $\\{(U_i, \varphi_i)\\}$ of local coordinates on $M$, where $U_i \subset M$ (a subset) and $\varphi_i: U_i \to \mathbb{R}^n$ is injective, such that
