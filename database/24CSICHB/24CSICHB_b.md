A *smooth* $n$-*manifold* is a set $M$, together with a collection $\\{U_i, \phi_i\\}$ of local coordinates of $M$, where $U_i \subset M$ and $\phi_i: U_i \to \mathbb{R}_n$, such that
- $M = \bigcup_i U_i$;
