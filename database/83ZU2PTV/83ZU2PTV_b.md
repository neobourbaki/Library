Let $f: U \to \mathbb{R}^m$ be a function on an open set $U \subseteq \mathbb{R}^n$, and $f_1, \ldots, f_m$ be the compoents of $f$. The *partial derivatives of* $f_i$ at $x^* = (x_1, \ldots, x_n) \in U$ are 
