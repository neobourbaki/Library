Let $f$ be a function of a single variable, i.e., $f: U \to \mathbf{K}$ on an open subset $U \subseteq \mathbf{K}$ of a normed field $\mathbf{K}$. The *derivative* of $f$ at $x_0 \in U$ is the limit
