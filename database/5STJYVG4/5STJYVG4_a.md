The *tensor product* of modules $M$ and $N$ over a commutative ring $R$ is a module $M \otimes_{R} N$ over $R$, together with a $R$-bilinear map $\phi: M \times N \to M \otimes N$, satisfying the universal property:
