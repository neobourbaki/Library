For $n \in \mathbb{N}$, a *vector* over a field $k$ is a $n$-tuple of elements of $k$, and the set of all vectors, with the natural addition and scalar multiplication, is a *vector space* over $k$ of dimension $n$.
