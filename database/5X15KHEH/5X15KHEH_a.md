Let $X$ be a topological space. The (singular) *homology* of $X$ with coefficients in an abelian group $A$ is the quotient group
...
- $C_n$ is the free $A$-module generated by the continuous maps $\Delta_n \to X$
